...
public class FragmentDecomissioned extends Fragment {
    ...
    private void initUI() {
        ...
        Cursor cursor = new DbOperations(getContext()).select(DbConstants.TABLE_ITEMS_V1, DbConstants.ASSET_STATUS_ID, GLConstants.WRITTEN_OFF);
        if (cursor != null) {
